...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Pat on WhatsApp"
      className="whatsapp-widget bg-green-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg"
    >
      <span className="sr-only">Chat with Pat on WhatsApp</span>
