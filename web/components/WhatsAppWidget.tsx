export default function WhatsAppWidget() {
  return (
    <a href="https://wa.me/447123456789" target="_blank" className="whatsapp-widget bg-green-500 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg">
