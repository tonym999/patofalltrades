export default function MobileNav() {
  const linkClassName =
    "interactive-focus-ring flex flex-col items-center rounded-lg px-2 py-1 text-gray-300 hover:text-gold";
  const primaryLinkClassName =
    "interactive-focus-ring flex flex-col items-center rounded-lg px-2 py-1 text-gold";

  return (
    <div className="md:hidden mobile-nav p-2">
      <div className="flex justify-around items-center">
        ...
        <a href="#contact" className={primaryLinkClassName}>
